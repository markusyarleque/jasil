...
$all_customers = find_all_provider();
?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="javascript:void(0);" data-id="<?php echo (int)$a_customer['id']; ?>" class="btn btn-xs btn-danger delete-provider" data-toggle="tooltip" title="Eliminar">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="confirmDeleteBtnProvider">Eliminar</button>
            </div>
        </div>
    </div>
</div>
