...
if (isset($_POST['add_provider'])) {
    ...
    if (empty($errors)) {
        ...
        $user_id    = (int)$user['id'];
        $e_provider = find_provider_by_doc($document_type, $document);
        if ($e_provider) {
            ...
            if ($db->query($query)) {
                //sucess
                $session->msg('s', " El proveedor ha sido registrado");
                redirect('add.php', false);
            } else {
                //failed
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <a href="providers.php" class="btn pull-right btn-xs" title="Cerrar"><span class="	glyphicon glyphicon-remove"></span></a>
            </strong>
        </div>
            ...
            <div class="col-md-6">
                <form method="post" action="add.php">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="address" placeholder="Dirección de proveedor" rows="3" cols="50"></textarea>
                    </div>
                    <div class="form-group clearfix">
                        <button type="submit" name="add_provider" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-saved"></span> Guardar</button>
                    </div>
                </form>
            </div>
        </div>
