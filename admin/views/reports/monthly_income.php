...
if (isset($_POST['month']) && isset($_POST['year'])) {
  ...
  if ($provider != null && $provider != 0) {
    $incomes = monthlyIncomesxProvider($year, $month, $provider);
  } else {
    $incomes = monthlyIncomes($year, $month);
  }
...
<div class="row">
  <div class="col-md-6">
    ...
    <form method="post" action="ajax.php" autocomplete="off" id="prov-form">
  ...
  <div class="col-md-6">
    <form method="post" action="monthly_income.php" autocomplete="off" id="search-prov">
      <div class="form-group">
        <div class="input-group">
    ...
    <div class="panel panel-default">
        ...
        <strong>
          <form>
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                <select class="form-control" name="select_month_i" id="s_month">
                  <?php for ($i = 1; $i <= 12; $i++): ?>
              ...
              <div class="form-group col-md-2">
                <select class="form-control" name="select_year_month_i" id="s_year">
      ...
      <div class="panel-body">
        ...
        <div class="tittle_prov" id="idProvider">
          <!-- Aquí se cargará el proveedor buscado -->
        </div>
