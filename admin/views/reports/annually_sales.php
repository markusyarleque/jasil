...
if (isset($_POST['year'])) {
    ...
    if ($customer != null && $customer != 0) {
        $sales = annuallySalesxCustomer($year, $customer);
    } else {
        $sales = annuallySales($year);
    }
...
<div class="row">
    ...
    <div class="col-md-6">
        <form method="post" action="annually_sales.php" autocomplete="off" id="search-clie">
            <div class="form-group">
                <div class="input-group">
