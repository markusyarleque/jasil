...
if (isset($_POST['day']) && isset($_POST['month']) && isset($_POST['year'])) {
    ...
    if ($customer != null && $customer != 0) {
        $sales = dailySalesxCustomer($year, $month, $day, $customer);
    } else {
...
<div class="row">
    ...
    <div class="col-md-6">
        <form method="post" action="daily_sales.php" autocomplete="off" id="search-clie">
            <div class="form-group">
                <div class="input-group">
                ...
                <strong>
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <select class="form-control" name="select_day" id="s_day">
                                    <?php for ($i = 1; $i <= 30; $i++): ?>
                            ...
                            <div class="form-group col-md-2">
                                <select class="form-control" name="select_month_daily" id="s_month_daily">
                                    <?php for ($i = 1; $i <= 12; $i++): ?>
                            ...
                            <div class="form-group col-md-2">
                                <select class="form-control" name="select_year_daily" id="s_year_daily">
