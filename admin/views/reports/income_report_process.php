...
<body>
  <?php if ($results): ?>
    <div class="page-break">
      <div class="income-head pull-right">
        ...
        <tbody>
          ...
          <?php foreach ($results as $result): ?>
            <tr>
              ...
              <td><?php echo remove_junk(ucfirst($result['name_provider'])); ?></td>
              <td class="text-center"><?php echo remove_junk(ucfirst($result['document_provider'])); ?></td>
              <td><?php echo remove_junk(ucfirst($result['name'])); ?></td>
              <td class="text-center"><?php echo (int)$result['qty']; ?></td>
              <td class="text-center"><?php echo (int)$result['buy_price']; ?></td>
            ...
            $sum_igv += $result['igv'];
            $sum_total += $result['total_buying_price'];
            ?>
          <?php endforeach; ?>
        </tbody>
        <tfoot>
          <tr class="text-right">
            ...
            <td class="text-right"> S/ <?php echo number_format(@total_price($results)[1], 2); ?>
            </td>
          </tr>
          <tr class="text-right">
            <td class="text-right" colspan="8">Total Ventas</td>
            <td class="text-right" colspan="3"> S/ <?php echo number_format(@total_price($results)[0], 2); ?></td>
          </tr>
          <tr class="text-right">
  ...
  <?php
    ...
    $session->msg("d", "No se encontraron compras. ");
    redirect('income_report.php', false);
  endif;
  ?>
</body>
