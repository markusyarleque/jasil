...
if (isset($_POST['year'])) {
    ...
    if ($provider != null && $provider != 0) {
        $incomes = annuallyIncomesxProvider($year, $provider);
    } else {
        $incomes = annuallyIncomes($year);
    }
...
<div class="row">
    ...
    <div class="col-md-6">
        <form method="post" action="annually_income.php" autocomplete="off" id="search-clie">
            <div class="form-group">
                <div class="input-group">
        ...
        <div class="panel panel-default">
                ...
                <strong>
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <select class="form-control" name="select_year_i">
            ...
            <div class="panel-body">
                ...
                <div class="tittle_prov" id="idProvider">
                    <!-- Aquí se cargará el provedor buscado -->
                </div>
