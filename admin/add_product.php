    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          ...
          <a href="product.php" class="btn pull-right btn-xs" title="Cerrar"><span class="	glyphicon glyphicon-remove"></span></a>
        </strong>
      </div>
      <div class="panel-body">
        <div class="col-md-12">
          <form method="post" action="add_product.php" class="clearfix">
            ...
            <button type="submit" name="add_product" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-saved"></span> Guardar</button>
          </form>
        </div>
      </div>
    </div>
